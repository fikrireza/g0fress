      ...
      <div class="x_content">
        <form action="{{ route('produk.store') }}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select id="kategori_id" name="kategori_id" class="form-control select2_single" required="required">
                ...
                @foreach ($getProdukKategori as $key)
                  <option value="{{ $key->id }}">{{ $key->nama_kategori_id}}</option>
                @endforeach
              </select>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="1" name="nama_produk_id" placeholder="Contoh: Nama Produk" required="required" type="text">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="textarea" required="required" name="deskripsi_en" class="form-control col-md-7 col-xs-12"></textarea>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="textarea" required="required" name="deskripsi_id" class="form-control col-md-7 col-xs-12"></textarea>
            </div>
          </div>
          <div class="item form-group">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="img_alt" class="form-control col-md-7 col-xs-12" data-validate-length-range="1" name="img_alt" placeholder="Contoh: Nama Produk" required="required" type="text">
            </div>
          </div>
          <div class="item form-group">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <label>
                <input type="checkbox" class="js-switch" name="flag_publish" checked />
              </label>
            </div>
          </div>
