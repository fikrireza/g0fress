      ...
      <div class="x_content">
        <form action="{{ route('produk.edit') }}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="deskripsi_ID" required="required" name="deskripsi_ID">{{ $getProduk->deskripsi_ID }}</textarea>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="deskripsi_EN" required="required" name="deskripsi_EN" class="form-control col-md-7 col-xs-12">{{ $getProduk->deskripsi_EN }}</textarea>
