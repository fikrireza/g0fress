...
@section('title')
  <title>Gofress | Tambah Produk Kategori</title>
@endsection
        ...
        <form action="{{ route('produkKategori.store') }}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
          ...
          <div class="item form-group {{ $errors->has('nama_kategori') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="nama_kategori" class="form-control col-md-7 col-xs-12" name="nama_kategori" placeholder="Contoh: Nama Produk Kategori" required="required" type="text" value="{{ old('nama_kategori') }}">
