...
@section('title')
  <title>Gofress | Tambah Kontak</title>
@endsection
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Tambah Kontak<small></small></h2>
      ...
      <div class="x_content">
        <form action="{{ route('kontak.store') }}" method="POST" class="form-horizontal form-label-left">
          {{ csrf_field() }}
          <div class="item form-group {{ $errors->has('kantor_kategori') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="kantor_kategori" class="form-control col-md-7 col-xs-12" name="kantor_kategori" placeholder="Contoh: Head Office" type="text" value="{{ old('kantor_kategori') }}" required="required">
          ...
          <div class="item form-group {{ $errors->has('alamat') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6">
              <textarea id="alamat" required="required" name="alamat">{{ old('alamat') }}</textarea>
          ...
          <div class="item form-group {{ $errors->has('email') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="email" class="form-control col-md-7 col-xs-12" name="email" placeholder="Contoh: fikrirezaa@gmail.com" value="{{ old('email') }}" required="required">
              @if($errors->has('email'))
          ...
          <div class="item form-group {{ $errors->has('no_telp') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="no_telp" class="form-control col-md-7 col-xs-12" name="no_telp" placeholder="Contoh: +62 765 789 669" type="text" value="{{ old('no_telp') }}" required="required">
