...
@section('title')
  <title>Gofress | Ubah Program & Events Kategori</title>
@endsection
        ...
        <form action="{{ route('programEventsKategori.edit') }}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
          ...
          <div class="item form-group {{ $errors->has('judul_kategori_ID') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="judul_kategori_ID" class="form-control col-md-7 col-xs-12" name="judul_kategori_ID" placeholder="Contoh: Judul Program Events Kategori" required="required" type="text" value="{{ old('judul_kategori_ID', $getProgramEventsKategori->judul_kategori_ID) }}">
          ...
          <div class="item form-group {{ $errors->has('judul_kategori_EN') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="judul_kategori_EN" class="form-control col-md-7 col-xs-12" name="judul_kategori_EN" placeholder="Eg: Program Events Category Title" required="required" type="text" value="{{ old('judul_kategori_EN', $getProgramEventsKategori->judul_kategori_EN) }}">
