...
@section('title')
<title>Gofress | Ubah Social Media</title>
@endsection
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Ubah Social Media<small></small></h2>
      ...
      <div class="x_content">
        <form action="{{ route('social.edit') }}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
          {{ csrf_field() }}
          <input type="hidden" name="id" value="{{ $getSocial->id }}">

          <div class="item form-group {{ $errors->has('nama') ? 'has-error' : ''}}">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nama <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="nama" class="form-control col-md-7 col-xs-12" name="nama" placeholder="Contoh: Facebook" required="required" type="text" value="{{ old('nama', $getSocial->nama) }}">
              @if($errors->has('nama'))
          ...
          <div class="item form-group {{ $errors->has('img_url') ? 'has-error' : ''}}">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Gambar Icon <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
          ...
          <div class="item form-group {{ $errors->has('url_account') ? 'has-error' : ''}}">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Link Social Media <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="url_account" class="form-control col-md-7 col-xs-12" name="url_account" placeholder="Contoh: http://facebook.com/amadeo.id" required="required" type="text" value="{{ old('url_account', $getSocial->url_account) }}">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <label>
                <input type="checkbox" class="flat" name="flag_publish" {{ $getSocial->flag_publish == 1 ? 'checked="checked"' : '' }}>
              </label>
            </div>
          </div>
          <div class="ln_solid"></div>
