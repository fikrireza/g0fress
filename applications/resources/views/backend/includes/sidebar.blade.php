    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <li class="{{ Route::currentRouteNamed('programEvents.index') ? 'active' : '' }}{{ Route::currentRouteNamed('programEvents.tambah') ? 'active' : '' }}{{ Route::currentRouteNamed('programEvents.lihat') ? 'active' : '' }}{{ Route::currentRouteNamed('programEvents.ubah') ? 'active' : '' }}{{ Route::currentRouteNamed('programEventsKategori.index') ? 'active' : '' }}{{ Route::currentRouteNamed('programEventsKategori.tambah') ? 'active' : '' }}{{ Route::currentRouteNamed('programEventsKategori.lihat') ? 'active' : '' }}">
            <a><i class="fa fa-calendar"></i> Program & Events <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu" style="{{ Route::currentRouteNamed('programEvents.index') ? 'display: block;' : '' }}{{ Route::currentRouteNamed('programEvents.tambah') ? 'display: block;' : '' }}{{ Route::currentRouteNamed('programEvents.lihat') ? 'display: block;' : '' }}{{Route::currentRouteNamed('programEvents.ubah') ? 'display: block;' : '' }}{{ Route::currentRouteNamed('programEventsKategori.index') ? 'display: block;' : '' }}{{ Route::currentRouteNamed('programEventsKategori.tambah') ? 'display: block;' : '' }}{{ Route::currentRouteNamed('programEventsKategori.lihat') ? 'display: block;' : '' }}">
