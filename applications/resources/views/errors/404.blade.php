...
<head>
	...
	<link rel="icon" type="image/png" href="{{ URL::to('/public') }}/source/picture/iconmini-GF.png" />
	<style type="text/css">
		body, html {
			width: 100%;
			height: 100%;
...
<body class="background">
	<div style="position: absolute;top: 15px;width: 100%;z-index: 1;">
		<div style="position: relative; margin: 0 auto;width: 100%; text-align: center;">
			<h1 style="color: rgb(85,85,85); font-size: 38px; margin: 5px 0; font-family: arial;">Are You Lost ? 404 Not Found!</h1>
			<h3 style="color: rgb(85,85,85); font-size: 20px; margin: 0 0; font-family: arial; font-weight: lighter;">The page you're looking for isn't here!</h3>
		</div>
	</div>
