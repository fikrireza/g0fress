...
<body class="background">
	<div style="position: absolute;top: 15px;width: 100%;z-index: 1;">
		<div style="position: relative; margin: 0 auto;width: 100%; text-align: center;">
			<h1 style="color: rgb(85,85,85); font-size: 38px; margin: 5px 0; font-family: arial;">This Site is Under Maintenance</h1>
			<h3 style="color: rgb(85,85,85); font-size: 20px; margin: 0 0; font-family: arial; font-weight: lighter;">We'll Be Back</h3>
		</div>
	</div>
